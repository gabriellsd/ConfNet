...
contextBridge.exposeInMainWorld('ConfNet', {
    ...
    scanWifiNetworks: () => ipcRenderer.invoke('network-scan-wifi'),
    debugWifiCommands: () => ipcRenderer.invoke('network-debug-wifi'),
    connectToWifi: (ssid, password) => ipcRenderer.invoke('network-connect-wifi', ssid, password),
